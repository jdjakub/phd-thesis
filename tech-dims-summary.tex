...
How much time must users spend accounting for syntax or format errors? &
Zero (explicit structure) vs. lots (implicit structure) \\
\hline NOTATION &
...
Notational Freedom &
How easily can the system integrate novel notations that the user has implemented? &
Encourages custom notations vs. enforces a single one \\
