...
\newcommand{\myTime}{September 2019--March 2024\xspace}
...
\newcommand{\criterion}{\emph}
% Thanks https://tex.stackexchange.com/a/32687
\NewDocumentCommand{\rot}{O{45} O{1em} m}{\makebox[#2][l]{\rotatebox{#1}{#3}}}%
%\newcommand{\mybox}[1]{\noindent\fbox{\parbox{\textwidth}{#1}}}
\newcommand{\mybox}[1]{\begin{quote}#1\end{quote}}
...
\newenvironment{head}{}{}
\newsavebox{\mywidebox} % to shrink the wide ascii art listing >.>

%\newcommand{\hypertarget}[1]{}

% Doesn't work, I just corrected them manually
\usepackage[shortcuts]{extdash}
\hyphenation{self\-sus-tain-abil-ity}
\hyphenation{Self\-sus-tain-abil-ity}
\hyphenation{Self\-Sus-tain-abil-ity}

% https://tex.stackexchange.com/questions/73063/acronym-hyperlink-without-special-color
\makeatletter
\AtBeginDocument{%
...
commentstyle=\color{OliveGreen}\rmfamily,
...
\lstdefinelanguage{JavaScript}{
  ...
  try, typeof, var, void, while, with, let, false, true, null, undefined},
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]',
  morestring=[b]",
...
\lstdefinelanguage{blasm}{
  keywords={load, store, deref, index, js},
  otherkeywords={store-reg},
  sensitive=true,
  comment=[l]{//},
}
\lstdefinelanguage{blasmmini}[]{blasm}{
  morekeywords={l, s, sr, d, i},
}
% ****************************************************************************************************
